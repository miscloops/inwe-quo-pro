...
async function fetchSessions(): Promise<Session[]> { const r = await fetch('/api/inwe/sessions'); if (!r.ok) throw new Error('failed'); const j = await r.json(); return j.sessions ?? [] }
...
export default function Home() {
  ...
  // Apply theme on mount (useTheme handles loading from localStorage + applying CSS vars)
  useTheme()
