    ...
    return (
      <>
        ...
        <button
          ...
          className="fixed bottom-3 right-3 z-50 text-[10px] border border-[var(--border)] bg-[var(--card)] px-2 py-1 text-[var(--muted-foreground)] hover:bg-[var(--secondary)] transition-colors"
      ...
      <div className="w-full max-w-sm border-2 border-[var(--border)] bg-[var(--card)] p-6">
        <div className="text-center mb-6">
          ...
          <p className="text-[10px] text-[var(--muted-foreground)] mt-2">
            Your account isolates your iNwe sessions from other users.
            <br />Nobody else can see your logged-in IDs.
          </p>
        </div>
        ...
        <div className="space-y-3">
          <div>
            <input
              ...
              className="w-full bg-[var(--muted)] border border-[var(--border)] px-4 py-2.5 text-sm outline-none focus:border-[var(--primary)]"
              autoFocus
          ...
          <button
            ...
            className="w-full bg-[var(--primary)] text-[var(--primary-foreground)] py-2.5 text-sm font-bold disabled:opacity-50 hover:opacity-90 transition-opacity"
          >
        ...
        <div className="mt-6 pt-4 border-t border-[var(--border)] text-center">
          <p className="text-[10px] text-[var(--muted-foreground)]">
            Build 10003 · Made with ❤ in Maldives
          </p>
        </div>
      </div>
    </div>
